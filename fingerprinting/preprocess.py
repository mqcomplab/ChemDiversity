...
def preprocess_db(df,smiles_col="SMILES", mol_col="ROMol", standardize_ROMol=True, verbose=False):
    ...
    2. Standadize the molecules applying `standardize_molecule` to each molecule.
        2.1. Standardize format
        2.2. Removes salts
        2.3. Removes fragments / mixtures
        2.4. Removes charges by adding / removing H
        2.5. Canonicalize tautomers
    3. Generate InChI Keys
    4. Remove molecules with invalid atoms
    5. Remove duplicates based on InChI keys
